    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-100 via-blue-100 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-950">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Link href="/blog" className="bg-white/90 rounded-xl shadow-lg shadow-sky-100 p-6 hover:shadow-xl hover:shadow-sky-100 transition transform hover:-translate-y-1 border border-sky-100 dark:bg-slate-800/90 dark:border-slate-700 dark:shadow-slate-900/30 dark:hover:shadow-slate-800/30">
          ...
          <Link href="/about" className="bg-white/90 rounded-xl shadow-lg shadow-sky-100 p-6 hover:shadow-xl hover:shadow-sky-100 transition transform hover:-translate-y-1 border border-sky-100 dark:bg-slate-800/90 dark:border-slate-700 dark:shadow-slate-900/30 dark:hover:shadow-slate-800/30">
            <div className="text-accent mb-4 dark:text-sky-400">
              <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link href="/gallery" className="bg-white/90 rounded-xl shadow-lg shadow-sky-100 p-6 hover:shadow-xl hover:shadow-sky-100 transition transform hover:-translate-y-1 border border-sky-100 dark:bg-slate-800/90 dark:border-slate-700 dark:shadow-slate-900/30 dark:hover:shadow-slate-800/30">
            <div className="text-primary-light mb-4 dark:text-sky-400">
              <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
