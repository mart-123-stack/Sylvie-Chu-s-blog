        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="space-x-6">
              ...
              <Link href="/blog" className="text-foreground/70 hover:text-primary transition">Blog</Link>
              <Link href="/about" className="text-foreground/70 hover:text-primary transition">About</Link>
              <Link href="/gallery" className="text-foreground/70 hover:text-primary transition">Gallery</Link>
            </div>
          </div>
        </div>
      </nav>
